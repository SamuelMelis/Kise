...
import { DollarSign, Briefcase, Plus, Trash2, Landmark, Bitcoin, TrendingUp, Home, Box, Wallet, X } from 'lucide-react';
...
export const IncomeTab: React.FC = () => {
  ...
  const handleAddAsset = (e: React.FormEvent) => {
    ...
    addAsset({
      name: assetName,
      amountUSD: parseFloat(assetAmount),
      type: assetType
    });
            ...
            {assets.map(asset => {
              ...
              return (
                <div key={asset.id} className="bg-white p-4 rounded-2xl border border-gray-100 flex justify-between items-center group hover:border-[#18181b] transition-all">
                  ...
                  <div className="flex items-center gap-4">
                    <span className="font-mono font-bold text-[#18181b] tracking-tight">${asset.amountUSD.toLocaleString()}</span>
